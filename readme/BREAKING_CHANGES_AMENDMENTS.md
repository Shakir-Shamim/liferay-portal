...
## What ./readme/BREAKING_CHANGES_AMENDMENTS.md

The message is not correct.

## Why

This commit should not be reported as a breaking change. The correct message is: LPD-102355 Enforce DOWNLOAD permission on /c/document_library/get_file
```